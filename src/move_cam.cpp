 ...
 * @brief Server node done to move the arm of the robot
 * @version 0.1
 * @date 2023-02-09
 * 
 ...
 * 
 * Published to: <BR>
 *  /robot/joint1_position_controller/command to move the base of the robot arm
 *  /robot/joint2_position_controller/command to move the camera at the top of the arm
 * 
 * Services: <BR>
 *  /arm_info to decide if the arm should move or stop
 * 
 * Description:
 ...
 * dergee both upwards and downwards. This is done until all markers have been detected.
 * When all markers have been detected, a request from the client node is made. This server node makes the arm
